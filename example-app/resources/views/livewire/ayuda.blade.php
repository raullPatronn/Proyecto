                ...
                <div class="mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 gap-10 translate-y-12">
                  @foreach($solicitudes as $solicitud)
                    <div class="bg-white rounded-lg overflow-hidden transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl sm:w-full md:w-full xl:w-full">
                      <div class="bg-gradient-to-br from-purple-400 to-purple-600 p-4 flex items-center justify-center">
                      ...
                      <div class="p-6">
                        @if($editarId == $solicitud->id)
                          <input type="text" id="titulo" name="titulo" wire:model="titulo" placeholder="Título" class="w-full mb-2 text-gray-700 font-bold text-2xl border-b-2 border-gray-300 focus:outline-none focus:border-red-700">
                          <textarea type="text" id="descripcion" name="descripcion" wire:model="descripcion" placeholder="Descripción" class="w-full mb-2 text-gray-700 border-b-2 border-gray-300 focus:outline-none focus:border-red-700"></textarea>
                          <select id="ayuda" wire:model="ayuda" autofocus class="w-full mb-2 text-gray-700 border-b-2 border-gray-300 focus:outline-none focus:border-red-700">
                            <option value="">Seleccione una opción</option>
                            <option value="Masculino">Masculino</option>
                            <option value="Femenino">Femenino</option>
                          </select>
                          <div class="flex justify-end">
                            <button wire:click="actualizarSolicitud({{ $solicitud->id }})" class="text-green-500 font-bold mr-2 focus:outline-none focus:shadow-outline hover:text-green-700">
                              Guardar
                            </button>
                        ...
                        @else
                          ...
                          <p class="text-gray-700 text-base text-red-700 mb-2"><strong>Ayuda Preferible:</strong> {{ $solicitud->ayuda }}</p>
                          <div class="flex justify-end">
